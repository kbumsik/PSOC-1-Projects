...
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	...
	db		32h, ffh		;TachTimer_COMPARE_LSB_REG(DBB10DR2)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	...
	db		36h, ffh		;TachTimer_COMPARE_MSB_REG(DBB11DR2)
...
;  Ordered Global Register values
	...
	mov	reg[05h], 2eh		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 3ah		; Port_1_DriveMode_2 register (PRT1DM2)
