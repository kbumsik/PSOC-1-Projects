...
export LoadConfig_lab2
export _LoadConfig_lab2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab2
	lcall	LoadConfigTBL_lab2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab2
;
;    Load configuration registers for lab2.
...
_LoadConfig_lab2:
 LoadConfig_lab2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab2_Bank0
    mov     X, <LoadConfigTBL_lab2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab2_Bank1
    mov     X, <LoadConfigTBL_lab2_Bank1
