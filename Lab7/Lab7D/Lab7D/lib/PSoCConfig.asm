...
export LoadConfig_lab7d
export _LoadConfig_lab7d
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab7d
	lcall	LoadConfigTBL_lab7d_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab7d
;
;    Load configuration registers for lab7d.
...
_LoadConfig_lab7d:
 LoadConfig_lab7d:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab7d_Bank0
    mov     X, <LoadConfigTBL_lab7d_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab7d_Bank1
    mov     X, <LoadConfigTBL_lab7d_Bank1
