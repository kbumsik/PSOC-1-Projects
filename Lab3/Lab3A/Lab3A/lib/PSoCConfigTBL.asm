...
export LoadConfigTBL_lab3a_Bank1
export LoadConfigTBL_lab3a_Bank0
export LoadConfigTBL_lab3a_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab3a_Bank0:
...
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	...
	db		22h, 20h		;PWM8_1_COMPARE_REG(DBB00DR2)
;  Instance name PWM8a, User Module PWM8
;       Instance name PWM8a, Block Name PWM8(DBB10)
	db		33h, 00h		;PWM8a_CONTROL_REG(DBB10CR0)
	db		31h, ffh		;PWM8a_PERIOD_REG(DBB10DR1)
	db		32h, e0h		;PWM8a_COMPARE_REG(DBB10DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_lab3a_Bank1:
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	db		20h, 31h		;PWM8_1_FUNC_REG(DBB00FN)
	db		21h, 16h		;PWM8_1_INPUT_REG(DBB00IN)
	db		22h, 44h		;PWM8_1_OUTPUT_REG(DBB00OU)
;  Instance name PWM8a, User Module PWM8
;       Instance name PWM8a, Block Name PWM8(DBB10)
	db		30h, 31h		;PWM8a_FUNC_REG(DBB10FN)
	db		31h, 16h		;PWM8a_INPUT_REG(DBB10IN)
	db		32h, 44h		;PWM8a_OUTPUT_REG(DBB10OU)
