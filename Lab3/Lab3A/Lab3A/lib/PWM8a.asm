...
;  Global Symbols
;-----------------------------------------------
export  PWM8a_EnableInt
export _PWM8a_EnableInt
export  PWM8a_DisableInt
export _PWM8a_DisableInt
export  PWM8a_Start
export _PWM8a_Start
export  PWM8a_Stop
export _PWM8a_Stop
export  PWM8a_WritePeriod
export _PWM8a_WritePeriod
export  PWM8a_WritePulseWidth
export _PWM8a_WritePulseWidth
export  PWM8a_bReadPulseWidth
export _PWM8a_bReadPulseWidth
export  PWM8a_bReadCounter
export _PWM8a_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8a_ReadPulseWidth    ; deprecated
export _bPWM8a_ReadPulseWidth    ; deprecated
export  bPWM8a_ReadCounter       ; deprecated
export _bPWM8a_ReadCounter       ; deprecated


AREA lab3a_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8a_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8a_WritePeriod
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8a_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8a_WritePulseWidth:
_PWM8a_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8a_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8a_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8a_bReadPulseWidth:
_PWM8a_bReadPulseWidth:
 bPWM8a_ReadPulseWidth:                          ; this name deprecated
_bPWM8a_ReadPulseWidth:                          ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8a_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8a_bReadCounter
;
;  DESCRIPTION:
...
;
 PWM8a_bReadCounter:
_PWM8a_bReadCounter:
 bPWM8a_ReadCounter:                             ; this name deprecated
_bPWM8a_ReadCounter:                             ; this name deprecated
   ...
   mov   A, reg[PWM8a_COMPARE_REG]               ; Save the Compare register on the stack
   push  A                                       ;
   PWM8a_Stop_M                                  ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8a_INPUT_REG]                 ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8a_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8a_COUNTER_REG]               ; DR2 <- DR0
   mov   A, reg[PWM8a_COMPARE_REG]               ; Stash the Count on the stack
   ...
   mov   reg[PWM8a_INPUT_REG], A                 ;
   M8C_SetBank0                                  ;
   PWM8a_Start_M                                 ;   then re-enable the PWM.
