...
export LoadConfig_lab3a
export _LoadConfig_lab3a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab3a
	lcall	LoadConfigTBL_lab3a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab3a
;
;    Load configuration registers for lab3a.
...
_LoadConfig_lab3a:
 LoadConfig_lab3a:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab3a_Bank0
    mov     X, <LoadConfigTBL_lab3a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab3a_Bank1
    mov     X, <LoadConfigTBL_lab3a_Bank1
