...
include "m8c.inc"
include "memory.inc"
include "MuteTimer.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  MuteTimer_EnableInt
export _MuteTimer_EnableInt
export  MuteTimer_DisableInt
export _MuteTimer_DisableInt
export  MuteTimer_Start
export _MuteTimer_Start
export  MuteTimer_Stop
export _MuteTimer_Stop
export  MuteTimer_WritePeriod
export _MuteTimer_WritePeriod
export  MuteTimer_WriteCompareValue
export _MuteTimer_WriteCompareValue
export  MuteTimer_bReadCompareValue
export _MuteTimer_bReadCompareValue
export  MuteTimer_bReadCounter
export _MuteTimer_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bMuteTimer_ReadCompareValue  ; deprecated
export _bMuteTimer_ReadCompareValue  ; deprecated
export  bMuteTimer_ReadCounter       ; deprecated
export _bMuteTimer_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_EnableInt
;
;  DESCRIPTION:
...
;
 MuteTimer_EnableInt:
_MuteTimer_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   MuteTimer_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 MuteTimer_DisableInt:
_MuteTimer_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   MuteTimer_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 MuteTimer_WritePeriod:
_MuteTimer_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[MuteTimer_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 MuteTimer_WriteCompareValue:
_MuteTimer_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[MuteTimer_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 MuteTimer_bReadCompareValue:
_MuteTimer_bReadCompareValue:
 bMuteTimer_ReadCompareValue:                    ; this name deprecated
_bMuteTimer_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[MuteTimer_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: MuteTimer_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 MuteTimer_bReadCounter:
_MuteTimer_bReadCounter:
 bMuteTimer_ReadCounter:                         ; this name deprecated
_bMuteTimer_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[MuteTimer_COMPARE_REG]           ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[MuteTimer_CONTROL_REG]           ; Save CR0 (running or stopped state)
   push  A                                       ;
   MuteTimer_Stop_M                              ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[MuteTimer_INPUT_REG]             ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[MuteTimer_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[MuteTimer_COUNTER_REG]           ; DR2 <- DR0
   mov   A, reg[MuteTimer_COMPARE_REG]           ; Stash the Count on the stack
   ...
   mov   reg[MuteTimer_INPUT_REG], A             ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[MuteTimer_CONTROL_REG], A           ;     this function was first called
