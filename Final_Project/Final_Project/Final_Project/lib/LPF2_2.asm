...
LPF2_2_IfCond:          equ LPF2_2_AMD_MSK & 0x01

IF (LPF2_2_AMD_VAL)
 IF (LPF2_2_IfCond)
  LPF2_2_AMD:           equ LPF2_2_AMD_VAL
 ELSE
  LPF2_2_AMD:           equ LPF2_2_AMD_VAL << 4
 ENDIF
ENDIF
...
IF (LPF2_2_AMD_VAL)
   M8C_SetBank1
   mov   A, reg[LPF2_2_AMD_REG]                  ; read modulator register
   and   A, ~LPF2_2_AMD_MSK                      ; clear modulator bittfield in A
   or    A, LPF2_2_AMD                           ; combine modulator value with balance of register
   mov   reg[LPF2_2_AMD_REG], A                  ; move complete value back to register
   M8C_SetBank0
ENDIF
