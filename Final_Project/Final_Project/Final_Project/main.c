...
// fsm function
void stopwatch_fsm(event event_input){
	static const transition stopped_transitions[] = {
	//	Event			Task		Next_state
		{short_pressed, start_timer, running},
		{eol,			do_nothing,	stopped}
	};
	static const transition running_transitions[] = {
	//	Event			Task		Next_state
		{short_pressed, pause_timer, paused},
		{eol,			do_nothing,	running}
	};
	static const transition paused_transitions[] = {
	//	Event			Task		Next_state
		{short_pressed, start_timer, running},
	...
	static const transition *fsm_table[3] = {
		stopped_transitions,
		running_transitions,
		paused_transitions
	};
	// stopwatch current state
	static state cs = stopped;
