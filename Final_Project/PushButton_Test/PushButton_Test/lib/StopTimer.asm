...
;  Global Symbols
;-----------------------------------------------
export  StopTimer_EnableInt
export _StopTimer_EnableInt
export  StopTimer_DisableInt
export _StopTimer_DisableInt
export  StopTimer_Start
export _StopTimer_Start
export  StopTimer_Stop
export _StopTimer_Stop
export  StopTimer_WritePeriod
export _StopTimer_WritePeriod
export  StopTimer_WriteCompareValue
export _StopTimer_WriteCompareValue
export  StopTimer_wReadCompareValue
export _StopTimer_wReadCompareValue
export  StopTimer_wReadTimer
export _StopTimer_wReadTimer
export  StopTimer_wReadTimerSaveCV
export _StopTimer_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wStopTimer_ReadCompareValue  ; deprecated
export _wStopTimer_ReadCompareValue  ; deprecated
export  wStopTimer_ReadTimer         ; deprecated
export _wStopTimer_ReadTimer         ; deprecated
export  wStopTimer_ReadTimerSaveCV   ; deprecated
export _wStopTimer_ReadTimerSaveCV   ; deprecated

export  wStopTimer_ReadCounter       ; obsolete
export _wStopTimer_ReadCounter       ; obsolete
export  wStopTimer_CaptureCounter    ; obsolete
export _wStopTimer_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_EnableInt
;
;  DESCRIPTION:
...
;
 StopTimer_EnableInt:
_StopTimer_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   StopTimer_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 StopTimer_DisableInt:
_StopTimer_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   StopTimer_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 StopTimer_WritePeriod:
_StopTimer_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[StopTimer_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[StopTimer_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 StopTimer_WriteCompareValue:
_StopTimer_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[StopTimer_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[StopTimer_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 StopTimer_wReadCompareValue:
_StopTimer_wReadCompareValue:
 wStopTimer_ReadCompareValue:                    ; this name deprecated
_wStopTimer_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[StopTimer_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[StopTimer_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 StopTimer_wReadTimerSaveCV:
_StopTimer_wReadTimerSaveCV:
 wStopTimer_ReadTimerSaveCV:                     ; this name deprecated
_wStopTimer_ReadTimerSaveCV:                     ; this name deprecated
 wStopTimer_ReadCounter:                         ; this name deprecated
_wStopTimer_ReadCounter:                         ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[StopTimer_CONTROL_LSB_REG]       ; save the Control register
   push  A
   mov   A, reg[StopTimer_COMPARE_LSB_REG]       ; save the Compare register
   push  A
   mov   A, reg[StopTimer_COMPARE_MSB_REG]
   push  A
   mov   A, reg[StopTimer_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[StopTimer_COMPARE_MSB_REG]       ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[StopTimer_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   StopTimer_Stop_M                              ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[StopTimer_COMPARE_MSB_REG], A
   pop   A
   mov   reg[StopTimer_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[StopTimer_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: StopTimer_wReadTimer
;
;  DESCRIPTION:
...
;
 StopTimer_wReadTimer:
_StopTimer_wReadTimer:
 wStopTimer_ReadTimer:                           ; this name deprecated
_wStopTimer_ReadTimer:                           ; this name deprecated
 wStopTimer_CaptureCounter:                      ; this name deprecated
_wStopTimer_CaptureCounter:                      ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[StopTimer_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[StopTimer_COMPARE_MSB_REG]       ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[StopTimer_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
