...
export LoadConfig_lab1
export _LoadConfig_lab1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab1
	lcall	LoadConfigTBL_lab1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab1
;
;    Load configuration registers for lab1.
...
_LoadConfig_lab1:
 LoadConfig_lab1:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab1_Bank0
    mov     X, <LoadConfigTBL_lab1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab1_Bank1
    mov     X, <LoadConfigTBL_lab1_Bank1
