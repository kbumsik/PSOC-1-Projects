...
export LoadConfig_example_uart_28pin
export _LoadConfig_example_uart_28pin
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_example_uart_28pin
...
;---------------------------------------------------------------------------
; Load Configuration example_uart_28pin
;
;    Load configuration registers for example_uart_28pin.
...
;               CUR_PP
;
_LoadConfig_example_uart_28pin:
 LoadConfig_example_uart_28pin:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_example_uart_28pin            ; Call load config table routine
